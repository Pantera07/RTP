...
import net.gahvila.rtp.Commands.CmdForceRtp;
import net.gahvila.rtp.Commands.CmdRtp;
import net.gahvila.rtp.Commands.CmdRtpAdmin;
import net.gahvila.rtp.Messages.Messages;
import net.gahvila.rtp.PluginHooks.ClaimsManager;
...
import static net.gahvila.rtp.PluginHooks.LrWorldGuard.registerWorldGuardFlag;
