...
import net.gahvila.rtp.Distribution.DistributionSettings;
...
import net.gahvila.rtp.SafeLocation.SafeLocationFinderBukkitThread;
import net.gahvila.rtp.SafeLocation.SafeLocationFinderOtherThread;
...
import static net.gahvila.rtp.RTP.*;
import static net.gahvila.rtp.Messages.MessageStyles.DebugDisplayLines.*;
import static net.gahvila.rtp.Messages.MessageStyles.enabledOrDisabled;
    ...
    throws JrtpBaseException, JrtpBaseException.PluginDisabledException {
        try {
            ...
            while (settings.locationQueue.size() < settings.cacheLocationCount) {
                RTP.locFinderRunnable.waitIfNonMainThread();
