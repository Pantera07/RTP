...
import static net.gahvila.rtp.RTP.infoLog;
import static net.gahvila.rtp.RTP.log;
...
public class LocationCacheFiller implements Runnable {
    ...
    private final WeakReference<RTP> pluginReference;

    private boolean keepRunning = true;

    public LocationCacheFiller(RTP RTP, long recheckTime, long betweenTime) {
        pluginReference = new WeakReference<>(RTP);
     ...
     */
    private RTP pluginMain() throws ReferenceNonExistentException {
